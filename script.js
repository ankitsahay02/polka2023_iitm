...
const speakerObj = {
  ...
  profileImg: ['./assets/ben_emerson.jpg', './assets/preethi_soundararajan.jpg', './assets/claire_bourquard.jpg', './assets/vishnu_unni.jpg', './assets/lipika_kabiraj.jpeg', './assets/achintya_mukhopadhyay.png'],
  name: ['Benjamin Lee Emerson II', 'Preethi Rajendram Soundararajan', 'Claire Bourquard', 'Vishnu Rajasekharan Unni', 'Lipika Kabiraj', 'Achintya Mukhopadhyay'],
  title: ['Software Development Student at Microverse', 'Director of Art Centre Nabi and a board member of CC Korea', 'Executive Director of the Wikimedia Foundation', '', 'President of Young Pirates of Europe', 'CEO of Creative Commons, ex COO of the Mozilla Foundation'],
