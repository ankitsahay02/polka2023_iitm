...
const speakerObj = {
  ...
  profileImg: ['./assets/ben_emerson.jpg', './assets/preethi_soundararajan.jpg', './assets/claire_bourquard.jpg', './assets/vishnu_unni.jpg', './assets/lipika_kabiraj.jpeg', './assets/vineeth_nair', './assets/achintya_mukhopadhyay.png'],
  name: ['Benjamin Lee Emerson II', 'Preethi Rajendram Soundararajan', 'Claire Bourquard', 'Vishnu Rajasekharan Unni', 'Lipika Kabiraj', 'Vineeth Nair', 'Achintya Mukhopadhyay'],
  title: ['Software Development Student at Microverse', 'sbksahbdaj', 'Director of Art Centre Nabi and a board member of CC Korea', 'Executive Director of the Wikimedia Foundation', '', 'President of Young Pirates of Europe', 'CEO of Creative Commons, ex COO of the Mozilla Foundation'],
  description: ['Mavericks has completed his Bachelor\'s degree in Civil Engineering in University of the Philippines - Diliman. He has started his coding journey end of January 2022 and was accepted as a full-time Microverse student mid of March of that year.', 'hvjhavjha', 'As the main venue for new media art production in Korea, Nabi promotes cross-disciplinary collaboration and understanding among science technology, humanities, and the arts.', 'Lila Tretikov is the Executive Director of the Wikimedia Foundation, the nonprofit organization that operates Wikipedia. Wikipedia is freely available in 290 languages and used by nearly half a billion people around the world every month.', 'Kilnam Chon helped bring the Internet to Asia and is an outspoken advocate for the open web and digital commons. In 2012, he was inducted into the inaugural class of the Internet Society\'s (ISOC) Internet Hall of Fame.', 'European ingetration, political democracy and participation of youth through online as her major condem, Reda\'s report outlining potential changes to EU copyright law was approved by the Parliament in July.', 'Achintya had been leading open-source projects at the Mozilla Foundation such as the open source movement.'],
};
